...
@Slf4j
@NoArgsConstructor
public class CentreVaccinationLineRecordReader extends RecordReader<CentreVaccinationLongWritable, CentreVaccinationText>  {
        ...
        private CentreVaccinationLongWritable key;
        private CentreVaccinationText value;
        private boolean isCompressedInput;
        private Decompressor decompressor;
        private byte[] recordDelimiterBytes;


        public CentreVaccinationLineRecordReader (byte[] recordDelimiter) {
        ...
        public void initialize(InputSplit genericSplit, TaskAttemptContext context) throws IOException {
            ...
            if (this.start != 0L) {
                this.start += (long)this.in.readLine(new CentreVaccinationText(), 0, this.maxBytesToConsume(this.start));
            }
        ...
        public boolean nextKeyValue() throws IOException {
            if (this.key == null) {
                this.key = new CentreVaccinationLongWritable();
            }

            this.key.set(this.pos);
            if (this.value == null) {
                this.value = new CentreVaccinationText();
            }
        ...
        public CentreVaccinationLongWritable getCurrentKey() {
            return this.key;
        }

        public CentreVaccinationText getCurrentValue() {
            return this.value;
        }
